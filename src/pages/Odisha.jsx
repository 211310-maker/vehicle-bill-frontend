...
const Odisha = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    if (
      ...
      payLoad.totalAmount = +payLoad.mvTax +
        +payLoad.permitFee +
  ...
  if (!isLoggedIn || !isLoggedIn.accessState || !isLoggedIn.accessState.includes(fields.stateName.odisha)) {
    return (
      <>
        <Header />
            ...
            <div className="col-12">
              <table className="hr-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="">3</td>
                    <td className="pb-table-text">Application Fee</td>
                    <td className=""></td>
                    <td className=""></td>
                    <td className="input-box">
                      <center>
                ...
                <input
                  ...
                  value={
                    (payLoad.vehiclePermitType ===
                      ...
                      (payLoad.vehiclePermitType === "GOODS VEHICLE" &&
                        payLoad.permitType === "NATIONAL PERMIT")
                      ? +payLoad.mvTax + +payLoad.applicationFee + +payLoad.permitFee
                      : +payLoad.mvTax + +payLoad.applicationFee + +payLoad.permitFee
                  }
                  className="form__input w-100"
                  type="number"
