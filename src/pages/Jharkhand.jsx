...
import { useHistory } from "react-router-dom"; // use react-router-dom
...
const Jharkhand = () => {
  ...
  // Guard the isLoggedIn check and use jharkhand
  if (!isLoggedIn || !isLoggedIn.accessState || !isLoggedIn.accessState.includes(fields.stateName.jharkhand)) {
    return (
      <>
        <Header />
