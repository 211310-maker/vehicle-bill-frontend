...
import { useHistory } from 'react-router-dom'; // use react-router-dom everywhere
...
const Bihar = () => {
  ...
  // Guard isLoggedIn so page doesn't crash if not logged in
  if (!isLoggedIn || !isLoggedIn.accessState || !isLoggedIn.accessState.includes(fields.stateName.bihar)) {
    return (
      <>
        <Header />
