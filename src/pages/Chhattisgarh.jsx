...
import { useHistory } from "react-router-dom"; // CHANGE to "react-router-dom" if other pages use that
...
const Chhattisgarh = () => {
  ...
  // ACCESS CHECK: ensure this checks CHHATTISGARH and is guarded
  if (
    !isLoggedIn ||
    !isLoggedIn.accessState ||
    !isLoggedIn.accessState.includes(fields.stateName.chhattisgarh)
  ) {
    return (
      <>
        <Header />
