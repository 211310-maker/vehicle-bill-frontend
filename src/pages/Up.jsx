...
const Up = () => {
  ...
  if (!isLoggedIn || !isLoggedIn.accessState || !isLoggedIn.accessState.includes(fields.stateName.up)) {
    return (
      <>
        <Header />
          ...
          <div className='row'>
            <div className='col-6'>
              ...
              <div className='row'>
                ...
                <div className='col-sm-6'>
                  <div className='form__control'>
                    <label className='form__label d-block w-100 text-left' htmlFor='permit-type'>
                      Permit Type<sup>*</sup>
                    </label>
                    <select
                      tabIndex='8'
            ...
            <div className='col-6'>
              ...
              <div className='form__control'>
                <label className='form__label d-block w-100 text-left' htmlFor='permitNumber'>
