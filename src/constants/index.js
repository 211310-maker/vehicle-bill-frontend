...
export const fields = {
  ...
  andhraPradesh: {
    // TODO: Expand full district list for ANDHRA PRADESH
    borderBarrier: [
      { name: "VISAKHAPATNAM" },
      { name: "VIJAYAWADA" },
      { name: "TIRUPATI" },
  ...
  arunachalPradesh: {
    // TODO: Expand full district list for ARUNACHAL PRADESH
    borderBarrier: [
      { name: "ITANAGAR" },
      { name: "TAWANG" },
      { name: "PASIGHAT" },
  ...
  goa: {
    // TODO: Expand full district list for GOA
    borderBarrier: [
      { name: "NORTH GOA" },
      { name: "SOUTH GOA" },
      { name: "PANAJI" },
  ...
  manipur: {
    // TODO: Expand full district list for MANIPUR
    borderBarrier: [
      { name: "IMPHAL WEST" },
      { name: "IMPHAL EAST" },
      { name: "THOUBAL" },
  ...
  meghalaya: {
    // TODO: Expand full district list for MEGHALAYA
    borderBarrier: [
  ...
  mizoram: {
    // TODO: Expand full district list for MIZORAM
    borderBarrier: [
      { name: "AIZAWL" },
      { name: "LUNGLEI" },
      { name: "KOLASIB" },
  ...
  nagaland: {
    // TODO: Expand full district list for NAGALAND
    borderBarrier: [
      { name: "DIMAPUR" },
      { name: "KOHIMA" },
      { name: "MOKOKCHUNG" },
  ...
  westBengal: {
    // TODO: Expand full district list for WEST BENGAL
    borderBarrier: [
      { name: "KOLKATA" },
      { name: "HOWRAH" },
      { name: "DARJEELING" },
