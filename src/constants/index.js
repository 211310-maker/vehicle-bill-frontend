...
export const fields = {
  ...
  allState: [
    { name: "ANDHRA PRADESH", code: "ap", value: "ANDHRA PRADESH", label: "ANDHRA PRADESH" },
    {
    ...
    { name: "GOA", code: "ga", value: "GOA", label: "GOA" },
    { name: "GUJARAT", code: "gj", value: "GUJARAT", label: "GUJARAT" },
    ...
    { name: "MANIPUR", code: "mn", value: "MANIPUR", label: "MANIPUR" },
    { name: "MEGHALAYA", code: "ml", value: "MEGHALAYA", label: "MEGHALAYA" },
    { name: "MIZORAM", code: "mz", value: "MIZORAM", label: "MIZORAM" },
    { name: "NAGALAND", code: "nl", value: "NAGALAND", label: "NAGALAND" },
    {
      name: "ODISHA",
      code: "od",
      value: "ODISHA",
    ...
    { name: "TAMIL NADU", code: "tn", value: "TAMIL NADU", label: "TAMIL NADU" },
    { name: "TELANGANA", code: "tg", value: "TELANGANA", label: "TELANGANA" },
    { name: "TRIPURA", code: "tr", value: "TRIPURA", label: "TRIPURA" },
    { name: "UTTAR PRADESH", code: "up", value: "UTTAR PRADESH", label: "UTTAR PRADESH" },
    { name: "UTTARAKHAND", code: "uk", value: "UTTARAKHAND", label: "UTTARAKHAND" },
    { name: "WEST BENGAL", code: "wb", value: "WEST BENGAL", label: "WEST BENGAL" },
    { name: "PUDUCHERRY", code: "py", value: "PUDUCHERRY", label: "PUDUCHERRY" },
    { name: "DAMAN & DIU", code: "dd", value: "DAMAN & DIU", label: "DAMAN & DIU" },
  ],
  fromState: [
    {
